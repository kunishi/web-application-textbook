...
では、盗聴・改ざん・なりすましへの対策の観点から、TLSの概要を説明することにしよう。なお、以下の説明では、理解を助けるために、各段階ではやや技術的に不正確な記述をあえて行なっている場合がある。
...
なりすましへの対策は、Webサーバの公開鍵$$PK_{serv}$$が正当なものであることを検証することであり、公開鍵暗号方式による電子署名が用いられている。
